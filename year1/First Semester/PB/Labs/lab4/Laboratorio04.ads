package Laboratorio04 is
    ...
    -- post: Resultado es la notafinal seg鷑 el m閠odo de calculo indicado
   ...
   --post: Resultado = digito que representan los segmentos a-g o -1 si no es un d韌ito
   ...
   procedure Poker (P1,P2,P3,P4,P5: in T_Palo;
     V1,V2,V3,V4,V5: in T_Valor; Jugada: out T_Jugada);
     --pre:Pi es el palo de la carta i; Vi es el valor de la carta i (i=1..5)
     --pre:Las cartas est醤 ordenadas de mayor valor a menor valor (A,K,Q,J,Diez...Dos)
