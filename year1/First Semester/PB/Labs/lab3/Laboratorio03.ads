package Laboratorio03 is
	...
	procedure Display_7_segmentos(N: in Natural; a,b,c,d,e,f,g: out Boolean);
	-- pre: N<10
	--post: x=true si el segmento x debe estar encendido al representar el digito N, siendo x=a,b,c,d,e,f,g
